...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[$(db_schema)].[classifier_eval_libsvm]') AND type in (N'U'))
DROP TABLE [$(db_schema)].[classifier_eval_libsvm]
GO
