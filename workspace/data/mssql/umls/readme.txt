...
bcp "select * from umls..MRCONSO where SAB in ('SNOMEDCT', 'NCI', 'ICD9CM', 'SRC')" queryout MRCONSO.bcp -S localhost -T -n
bcp "select * from umls..MRSTY where CUI in (select distinct CUI from umls..MRCONSO where SAB in ('SNOMEDCT', 'NCI', 'ICD9CM', 'SRC'))" queryout MRSTY.bcp -S localhost -T -n
bcp "select * from YTEX_TEST.test.umls_aui_fword where aui in (select distinct AUI from umls..MRCONSO where SAB in ('SNOMEDCT', 'NCI', 'ICD9CM', 'SRC'))" queryout umls_aui_fword.bcp -S localhost -T -n
