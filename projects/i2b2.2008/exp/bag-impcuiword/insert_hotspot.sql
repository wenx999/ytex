...
select d.docId, a.disease, 'i2b2.2008', 'bag-impcuiword'
...
where h.experiment = 'bag-impcuiword'
...
inner join i2b2_2008_cv_best b
    ...
    and b.experiment = 'bag-uswordsent100'
	and hs2.evaluation >= b.param1
set hs.evaluation = 1
;
