...
where e.experiment = 'kern-cuiword-filteredlin-test' and e.name = 'i2b2.2008'
;
...
where e.experiment = 'kern-cuiword-filteredlin-test'
...
(
	...
	(
		...
		inner join classifier_eval e 
			...
			and e.experiment = 'kern-cuiword-filteredlin-test'
			and e.name = 'i2b2.2008'
			and e.run = 0
			and e.fold = 0
    /* 
...
(
    ...
    (
		...
		and experiment = 'kern-cuiword-filteredlin-test'
	    and run = 0
	    and fold = 0
    ) s
...
(
	...
	where experiment = 'kern-cuiword-filteredlin-test'
	and name = 'i2b2.2008'
	and run = 0
	and fold = 0
