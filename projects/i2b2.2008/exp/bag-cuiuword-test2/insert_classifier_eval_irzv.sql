...
(
	...
	(
      ...
      and hi.experiment = 'bag-cuiuword'
...
where e.experiment = 'bag-cuiuword-test2'
...
(
	...
	(
		...
		inner join classifier_eval e 
			...
			and e.experiment = 'bag-cuiuword-test2'
			and e.name = 'i2b2.2008'
			and e.run = 0
			and e.fold = 0
    /* 
...
(
    ...
    (
		...
		and experiment = 'bag-cuiuword-test2'
	    and run = 0
	    and fold = 0
    ) s
...
(
	...
	where experiment = 'bag-cuiuword-test2'
	and name = 'i2b2.2008'
	and run = 0
	and fold = 0
