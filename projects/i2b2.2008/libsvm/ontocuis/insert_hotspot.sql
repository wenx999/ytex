...
inner join feature_eval e 
    ...
    and 
    (
        (e.featureset_name = 'ncuiword' and e.type = 'infogain' and param1 = '')
        or
        (e.featureset_name = 'ontocuis' and e.type = 'mutualinfo-child' and param1 = 'rbpar')
    )
/* get sentence for hotspot */
inner join anno_contain ac on ac.child_anno_base_id = ho.anno_base_id and ac.parent_uima_type_id = 9
where h.experiment = 'ontocuis'
