...
import edu.mayo.bmi.uima.cdt.ae.type.PersonTitleAnnotation;
import edu.mayo.bmi.uima.cdt.ae.type.RangeAnnotation;
import edu.mayo.bmi.uima.cdt.ae.type.RomanNumeralAnnotation;
import edu.mayo.bmi.uima.cdt.ae.type.TimeAnnotation;
import edu.mayo.bmi.uima.core.ae.TokenizerAnnotator;
import edu.mayo.bmi.uima.core.ae.type.ContractionToken;
import edu.mayo.bmi.uima.core.ae.type.NewlineToken;
import edu.mayo.bmi.uima.core.ae.type.NumToken;
import edu.mayo.bmi.uima.core.ae.type.PunctuationToken;
import edu.mayo.bmi.uima.core.ae.type.SymbolToken;
...
public class ContextDependentTokenizerAnnotator extends JTextAnnotator_ImplBase {
	...
	public void process(JCas jcas, ResultSpecification rs) throws AnnotatorProcessException {
		...
		try {
			...
			AnnotationIndex baseTokenIndex = jcas.getJFSIndexRepository().getAnnotationIndex(
					edu.mayo.bmi.uima.core.ae.type.BaseToken.type);
	 ...
	 * @return
	 */
	private BaseToken adaptToBaseToken(edu.mayo.bmi.uima.core.ae.type.BaseToken obj) throws Exception {
