...
public class KeyValuePair_Type extends TOP_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("ytex.uima.types.KeyValuePair");
  ...
  public String getKey(int addr) {
      ...
      jcas.throwFeatMissing("key", "ytex.uima.types.KeyValuePair");
  ...
  public long getValueLong(int addr) {
      ...
      jcas.throwFeatMissing("valueLong", "ytex.uima.types.KeyValuePair");
  ...
  public String getValueString(int addr) {
      ...
      jcas.throwFeatMissing("valueString", "ytex.uima.types.KeyValuePair");
