delete from hotspot_zero_vector_tt where name = 'i2b2.2008' and experiment like 'ambert%';  
...
select 'i2b2.2008', concat('ambert',cutoff), label, run, fold, ir_class_id, cutoff, tp, tn, fp, fn
from
(
	/* truth table */
