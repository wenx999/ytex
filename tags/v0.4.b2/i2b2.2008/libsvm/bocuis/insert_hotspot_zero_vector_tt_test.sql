delete from hotspot_zero_vector_tt where name = 'i2b2.2008' and experiment = 'bocuis-test';
...
select 'i2b2.2008', 'bocuis-test', label, ir_class_id, cutoff, tp, tn, fp, fn
from
(
	/* truth table */
