delete from hotspot_zero_vector where name = 'i2b2.2008-onto' and cutoff = @export.cutoff@;
...
select 'i2b2.2008-onto', disease, docId, @export.cutoff@
from
(
