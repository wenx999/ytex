...
insert into ref_segment_regex (segment_regex_id, segment_id, regex) values(segment_regex_id_sequence.nextval, 'CLINICAL_HISTORY', '\nClinical History\:\s*\r{0,1}\n');
insert into ref_segment_regex (segment_regex_id, segment_id, regex) values(segment_regex_id_sequence.nextval, 'REPORT', '\nReport\:\s*\r{0,1}\n');
insert into ref_segment_regex (segment_regex_id, segment_id, regex) values(segment_regex_id_sequence.nextval, 'IMPRESSION', '\nImpression\:\s*\r{0,1}\n');
