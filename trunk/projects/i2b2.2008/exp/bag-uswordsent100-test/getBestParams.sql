delete from i2b2_2008_cv_best where experiment = 'bag-uswordsent100';
...
(
  select label, cost, param1, run, fold, avg(f1) f1
    ...
    and experiment in ('bag-uswordsent100')
...
select label, 'bag-uswordsent100', f1
from
(
	/*
