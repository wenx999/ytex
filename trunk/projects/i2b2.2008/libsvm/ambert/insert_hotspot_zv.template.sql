delete from hotspot_zero_vector where name = 'i2b2.2008-word' and cutoff = @export.cutoff@;
...
select 'i2b2.2008-word', disease, docId, @export.cutoff@
from
(
