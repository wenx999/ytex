...
as
select fc.*, e.classifier_eval_id
...
create unique index NK_tmp_missing_ir on tmp_missing_ir (cv_fold_id, disease, disease_id, judgement_id, classifier_eval_id);
